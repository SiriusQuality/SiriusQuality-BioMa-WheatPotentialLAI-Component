...
namespace SiriusQualityWheatLAI.Strategies
{
	...
	/// <summary>
	///Class LaminaExpansionThermalTime
    /// Calculate Expansion Thermal Time Duration
    /// </summary>
	public class LaminaExpansionThermalTime : IStrategySiriusQualityWheatLAI
	{
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calculate Expansion Thermal Time Duration"; }
			}
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						...
						else throw new Exception("Parameter 'PexpL' not found (or found null) in strategy 'LaminaExpansionThermalTime'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("PexpL");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'PexpL' not found in strategy 'LaminaExpansionThermalTime'");
				}
			}
	...
	#region pre/post conditions management		
			...
			public string TestPostConditions(SiriusQualityWheatLAI.WheatLAIState wheatlaistate,SiriusQualityWheatLAI.WheatLeafState wheatleafstate,SiriusQualityWheatLAI.WheatLeafState wheatleafstate1, string callID)
			{
				try
				{
					...
					RangeBasedCondition r3 = new RangeBasedCondition(SiriusQualityWheatLAI.WheatLeafStateVarInfo.TTGroLamina);
					if(r3.ApplicableVarInfoValueTypes.Contains( SiriusQualityWheatLAI.WheatLeafStateVarInfo.TTGroLamina.ValueType)){prc.AddCondition(r3);}
